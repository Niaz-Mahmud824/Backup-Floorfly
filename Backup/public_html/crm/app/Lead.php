...
class Lead extends Model {
    ...
    protected $fillable = ['property_id','enquiry_property','verify_user_id','lead_status_id', 'lead_source_id', 'assigned_to', 'first_name' , 'last_name', 'position', 'email', 'website', 'phone', 'message', 'property_size_form', 'property_size_to', 'property_location', 'property_status', 'budget', 'facing', 'floor_position','lead_source','verify','verify_date','reffered_by', 'refer_person_name', 'refer_person_phone', 'refer_person_address', 'relation', 'special_note', 'company', 'is_important', 'address', 'city', 'state', 'zip_code', 'country_id', 'description', 'created_by', 'social_links' ,'smart_summary', 'photo'];
    ...
    static function statistics()
    {
        ...
        $extraWhere             = "";
        $leads                  = Lead::select('lead_status_id', DB::raw('count(*) as total'))->groupBy('lead_status_id')->whereNull('is_lost');
