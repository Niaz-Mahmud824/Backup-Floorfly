...
<nav id="sidebar" class="sidebar">
    ...
    <ul class="list-unstyled components" style="font-size: 14px;">
        ...
        <li class="{{ active_menu('leads') }}">
            <a href="#teamSubmenu" data-toggle="collapse" aria-expanded="{{ (active_menu('leads')) ? 'true' : 'false' }}"><i class="fas fa-tty menu-icon"></i>@lang('form.leads')</a>
            <ul class="collapse list-unstyled {{ (active_menu('leads')) ? 'show' : '' }}" id="teamSubmenu">
                <li><a href="{{ route('leads_list') }}">@lang('form.leads')</a></li>
                <li><a href="{{ route('pending_leads_list') }}">Pending Leads</a></li> 
            </ul>
        </li>
        ...
        <li class="{{ $teams }}">
            <a href="#teamSubmenu" data-toggle="collapse" aria-expanded="{{ ($teams) ? 'true' : 'false' }}"><i class="fas fa-users menu-icon"></i>@lang('form.teams_and_members')</a>
            <ul class="collapse list-unstyled {{ ($teams) ? 'show' : '' }}" id="teamSubmenu">
                ...
                <li><a href="{{ route('unassigned_team_members_list') }}">Unassigned Members</a></li>
                <li><a href="{{ route('pending_team_members_list') }}">Pending Members</a></li>
            </ul>
        </li>
        @endif
