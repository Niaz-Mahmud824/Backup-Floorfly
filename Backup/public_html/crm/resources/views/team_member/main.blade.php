...
@section('content')
    @php
        ...
        $group_name = ($route_name == 'edit_team_member_page' || $route_name == 'add_team_member_page' || $route_name == 'edit_pending_team_member_page') ? 'show_form' : app('request')->input('group');
