...
Route::post('/insertUser', 'ApiController@insertUsers');
Route::post('/inquiries_approved', 'ApiController@inquiries_approved');
...
// Customer
    ...
    Route::prefix('leads')->group(function (){
        ...
        Route::get('/', 'LeadController@index')->name('leads_list')->middleware('perm:[leads_view|leads_view_own|leads_create|leads_edit],is_multiple');
         ...
         Route::get('pending/leads/list', 'LeadController@pending_leads_list')->name('pending_leads_list');
...
Route::post('/apply', 'CreditNoteController@apply_credit_to_invoice')->name('apply_credit_to_invoice');
    ...
    Route::prefix('teams')->group(function (){
        ...
        Route::post('/pending_members', 'UserController@pending_paginate')->name('pending_datatables_team_members');
        ...
        Route::get('/pending/members', 'UserController@pending_member')->name('pending_team_members_list');
        Route::get('/members/edit/pending/{member}', 'UserController@edit_pending')->name('edit_pending_team_member_page')->middleware('perm:team_members_edit');
        Route::patch('/members/pending/edit/{member}', 'UserController@pending_update')->name('patch_pending_team_member')->middleware('perm:team_members_edit');

        Route::get('/unassigned/members', 'UserController@unassigned_member')->name('unassigned_team_members_list');
        Route::post('/unassigned_members', 'UserController@unassigned_paginate')->name('unassigned_datatables_team_members');
    ...
    Route::prefix('settings')->group(function (){     
        ...
        // Branch
        Route::prefix('support/branch')->group(function (){
            Route::get('/', 'DepartmentController@branch_list')->name('branch_list');
            Route::post('/branch/list', 'DepartmentController@paginate_branch')->name('datatables_branch');
            Route::post('/create/branch', 'DepartmentController@store_branch')->name('post_branch');
            Route::post('/edit/branch', 'DepartmentController@edit_branch')->name('get_information_branch');
            Route::post('/update/branch', 'DepartmentController@update_branch')->name('patch_branch');
            Route::get('/remove/branch/{branch}', 'DepartmentController@destroy_branch')->name('delete_branch');
        });
